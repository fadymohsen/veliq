...
export const SERVICES: Service[] = [
  {
    ...
    differentiators: [
      ...
      "Mobile-first by default, because more than 70% of your traffic is. Every layout is designed for the phone first.",
      "Speed is a budget, not a hope. We set a performance budget on day one and hold it through launch.",
      "Conversion-aware from copy to CTA. Every page has one job, and every section earns its place.",
    ],
    tiers: [
      {
        name: "Core",
        tagline: "The essentials done right.",
        features: ["Up to 5 pages", "Template-based customized design", "Basic CMS and on-page SEO setup", "Contact form integration", "1 language", "2 revision rounds"],
      },
      {
        name: "Precision",
        tagline: "Strategy and execution together.",
        features: ["Up to 10 pages", "Custom UI design and speed optimization", "CRM, booking, and analytics integrations", "Up to 2 languages", "Full on-page SEO", "4 revision rounds plus partial copywriting"],
      },
      {
        name: "Mastery",
        tagline: "Full ownership and maximum output.",
        features: ["Unlimited pages", "Full custom UX/UI design system", "Technical SEO audit and ongoing speed monitoring", "Full third-party ecosystem integrations", "Up to 3 languages", "Unlimited revisions plus full copywriting"],
      },
    ],
    ...
    signatureItems: [
      ...
      "Why should I trust them? Logos, proof, and numbers, not adjectives.",
      "How do they do it differently? One sentence, not a manifesto.",
      "What's the next step? One primary CTA, not five.",
      "Does this look like it was built recently? Visual currency is brand currency.",
    ],
    results: [
    ...
    faq: [
      ...
      { q: "Can you migrate our existing content and SEO rankings?", a: "Yes. A migration plan covering redirects, sitemap, and indexing checks is part of any rebuild so you don't lose the rankings your current site already earned." },
      ...
      { q: "What platform or CMS do you build on?", a: "We choose the CMS or framework based on your actual needs, content volume, your team's technical comfort, and integrations required, rather than defaulting to one platform for every client." },
    ...
    features: [
      ...
      "Bilingual and multilingual architecture",
    ],
    process: [
      ...
      { step: "Launch and Support", desc: "We deploy, monitor, and provide ongoing maintenance to keep your platform running at peak performance." },
    ],
  ...
  },
  {
    ...
    problemHeading: "The Problem We Saw",
    problemBody: "The SEO industry has trained clients to expect monthly reports full of vanity numbers: rankings on keywords no one buys from, traffic from countries that don't convert, and 'backlinks acquired' from sites no one visits. We work the opposite way. A naming note: this page uses 'local SEO' to mean geographic SEO, ranking in a specific city or region such as Cairo or Riyadh. That's a different thing from GEO, Generative Engine Optimization, covered below. Same three letters, unrelated meaning, and we keep them separate throughout.",
    differentiators: [
      ...
      "Built for GEO and AEO, not just the ten blue links. We optimize for Generative Engine Optimization, getting your business cited inside AI-generated answers on ChatGPT, Perplexity, and Google AI Overviews, and Answer Engine Optimization, structuring content and schema so an answer engine or voice assistant can pull it directly as the answer. Traditional rankings still matter. They're just no longer the only place a buyer's search ends.",
    ],
    tiers: [
      {
        name: "Core",
      ...
      },
      {
        name: "Precision",
        tagline: "Strategy and execution together.",
        features: ["Up to 25 keywords", "Full technical SEO audit", "Bi-weekly content recommendations", "Basic backlink building and local SEO", "GEO and AEO content structuring", "Monthly reporting plus insights"],
      },
      {
        name: "Mastery",
        tagline: "Full ownership and maximum output.",
        features: ["50+ keywords", "Full and ongoing technical SEO", "Weekly content recommendations", "Advanced backlinks, local SEO, and competitor tracking", "Full GEO and AEO program with AI-citation monitoring", "Weekly reporting plus strategy call"],
      },
    ],
    ...
    signatureItems: [
      ...
      "Your content gap map: pages that should exist and don't, ranked by search volume times commercial intent.",
    ...
    whyFaq: [
      { q: "Why a retainer instead of a project?", a: "Because SEO is a system, not a project. The first 90 days are technical and content. Months 4 to 12 are authority and competitive defense. Stop the work and your competitors take back what you earned." },
      { q: "Why so few keywords on the Core tier?", a: "Because 10 commercial-intent keywords driving revenue beat 100 vanity keywords that don't. We would rather rank you number one on what matters than fifteenth on a list that looks impressive." },
    ...
    faq: [
      ...
      { q: "What reporting do we actually receive?", a: "A report tied to your tier's cadence, monthly on Core, monthly with insights on Precision, and weekly plus a strategy call on Mastery, and every number includes the WHY behind it, not just the number itself." },
    ...
    process: [
      ...
      { step: "Measure and Refine", desc: "We track rankings, conversions, and competitor movement to continuously refine results." },
    ],
  ...
  },
  {
    ...
    tiers: [
      {
        ...
        features: ["Up to 5 screens and core flows", "iOS and Android from one codebase", "3 sprint cycles with device builds each", "Push notifications and basic auth", "REST API integration", "App Store and Play Store submission"],
      },
      {
        name: "Precision",
        tagline: "Feature-complete. Market-ready.",
        features: ["Up to 20 screens and user flows", "6 sprint cycles with client review each", "Social auth and biometric login", "Offline-first architecture", "In-app purchases or subscription billing", "Analytics and crash reporting integration"],
      },
      {
        name: "Mastery",
        tagline: "Native-grade. Ecosystem-connected.",
        features: ["Unlimited screens and flows", "Continuous sprint delivery", "Custom native modules where needed", "CI/CD pipeline and automated device testing", "Advanced integrations for maps, AR, payments, and IoT", "Post-launch performance SLA and support retainer"],
      },
    ],
    ...
    whyFaq: [
      ...
      { q: "Why test on real devices every sprint?", a: "Simulators lie. Performance, camera access, push notifications, and GPS all behave differently on real hardware. Discovering that on submission day is expensive. Discovering it on sprint day costs two hours." },
    ...
    faq: [
      ...
      { q: "How do sprint reviews actually work?", a: "Every two weeks you get a real device build, either TestFlight or a Play Store internal track, a walkthrough of what's new, and a chance to test and request changes before the next sprint starts, not a slide deck describing progress." },
    ...
    features: [
      ...
      "CI/CD with automated device testing (Detox and Maestro)",
    ],
    process: [
      { step: "Discovery and Prototype", desc: "We map every user flow, build a clickable prototype, and validate it before a line of code is written." },
      { step: "Sprint Development", desc: "Two-week sprints with a real device build at the end of each. You test on your phone, not a simulator." },
      { step: "Client Review and Sign-Off", desc: "You review working features, surface changes, and sign off before anything moves to the next sprint." },
      { step: "QA, Store Submission, and Launch", desc: "Full regression testing, App Store and Play Store compliance review, and a monitored production launch." },
    ],
  ...
  },
  {
    ...
    tiers: [
      {
        ...
        features: ["2 platforms managed", "12 posts per month", "Monthly content calendar and captions", "Monthly performance report"],
      },
      {
        name: "Precision",
        tagline: "Content built to grow, not just exist.",
        features: ["3 platforms managed", "20 posts per month including Reels and TikToks", "Content shoot day (photo and short video)", "Hashtag and trend research", "Bi-weekly performance reporting"],
      },
      {
        name: "Mastery",
        tagline: "A full in-house team, without the overhead.",
        features: ["4+ platforms managed", "Daily posting cadence", "Monthly content shoot and editing suite", "Influencer and UGC coordination", "Weekly reporting plus strategy call"],
      },
    ],
    ...
    signatureItems: [
      ...
      "Is there a next step? A profile visit, a link in bio, or a DM: something measurable.",
    ],
    results: [
    ...
    features: [
      "Platform-native content strategy for Instagram, TikTok, LinkedIn, and Facebook",
    ...
    process: [
      ...
      { step: "Produce and Publish", desc: "We shoot, edit, caption, and post on a consistent cadence." },
      { step: "Measure and Refine", desc: "We report on engagement, reach, and conversion monthly, and adjust the content mix based on what the data says, not what we assumed." },
    ],
  ...
  },
  {
    ...
    differentiators: [
      ...
      "Quarterly strategy reviews, not a document that ships once and gets ignored. Markets shift, so the plan has to be a living process, not a PDF.",
    ],
    tiers: [
      {
        name: "Core",
        tagline: "Clarity on where to focus.",
        features: ["Positioning and messaging workshop", "Competitor and market analysis", "Channel prioritization roadmap", "Quarterly strategy document", "One strategy review call"],
      },
      {
        name: "Precision",
        tagline: "A plan every channel executes against.",
        features: ["Everything in Core", "Full go-to-market plan", "Cross-channel content and campaign calendar", "Shared KPI scorecard across channels", "Monthly strategy check-in"],
      },
      {
        name: "Mastery",
        tagline: "Ongoing strategic partnership.",
        features: ["Everything in Precision", "Embedded strategic oversight across all active channels", "Budget allocation modeling and reforecasting", "Competitive response planning", "Weekly strategy sync and on-call advisory"],
      },
    ],
    ...
    results: [
      ...
      "Reduced channel redundancy: a measurable cut in spend on overlapping, underperforming tactics.",
    ...
    features: [
      ...
      "Quarterly strategy reviews and reforecasting",
    ],
    process: [
      ...
      { step: "Review and Adapt", desc: "We revisit the plan on a defined cadence, reallocating budget and priorities based on real performance data." },
    ],
  ...
  },
  {
    ...
    differentiators: [
      ...
      "Creative testing built into the media plan. We test 3 to 5 creative variations per campaign as standard, because the algorithm rewards fresh, tested creative over stagnant single ads.",
      "Full transparency on spend and platform fees. You see exactly what goes to media spend versus management, with no bundled black-box retainers.",
    ],
    tiers: [
      {
        name: "Core",
        tagline: "Structured spend, real tracking.",
        features: ["1 platform, Meta or Google", "Up to $3,000 per month ad spend managed", "Conversion tracking setup and audit", "Weekly optimization", "Monthly performance report"],
      },
      {
        name: "Precision",
        tagline: "Multi-platform, actively managed.",
        features: ["2 platforms, Meta plus Google or TikTok", "Up to $10,000 per month ad spend managed", "Creative testing with 3 to 5 variants per campaign", "Landing page conversion review", "Bi-weekly optimization and reporting"],
      },
      {
        name: "Mastery",
        tagline: "Full-funnel paid media operation.",
        features: ["3+ platforms managed", "$10,000+ per month ad spend managed", "Full-funnel campaign structure from awareness to retargeting", "Advanced audience and lookalike modeling", "Weekly optimization plus strategy call"],
      },
    ],
    ...
    signatureItems: [
      ...
      "Are we tracking the action that actually matters, a purchase or a qualified lead, not a proxy like a page view?",
    ...
    results: [
      ...
      "Return on ad spend tracked against a pre-agreed target, reviewed weekly.",
    ...
    whyFaq: [
      { q: "Why weekly budget shifts instead of monthly?", a: "Because a losing ad set left running for a full month is a full month of wasted spend. Platforms give you daily performance data, so ignoring it until the monthly report is a choice, not a limitation." },
      ...
      { q: "How is this different from just boosting posts?", a: "Boosting optimizes for engagement on a post. Media buying builds a funnel, awareness, retargeting, and conversion, with tracking that ties spend to revenue, not likes." },
    ...
    features: [
      ...
      "Conversion tracking and pixel/API implementation",
      "Full-funnel campaign structuring",
      "Creative testing and ad variation development",
      "Audience research and lookalike modeling",
      "Weekly optimization and transparent spend reporting",
    ],
    process: [
      { step: "Audit and Setup", desc: "We verify or install tracking, audit any existing campaigns, and confirm the metrics that actually matter for your business." },
      { step: "Plan", desc: "We build the funnel structure, audience targeting, and creative brief before a single ad goes live." },
      { step: "Launch and Test", desc: "We launch with multiple creative and audience variants running in parallel to identify what performs fastest." },
