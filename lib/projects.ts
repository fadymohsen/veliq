...
export const PROJECTS: Project[] = [
  {
    ...
    problemBody: "Alfa Transport was managing a fleet of 120+ vehicles across Saudi Arabia, Egypt, and the UAE with nothing but a basic contact page. Clients couldn't track shipments, request quotes, or verify credentials online, which led to lost enterprise contracts and a credibility gap with larger buyers.",
  ...
  },
  {
    ...
    problemBody: "Brandlab was producing exceptional video content, including editing, motion graphics, sound design, and brand films, but relied entirely on word-of-mouth and social media DMs. Without a website, potential clients couldn't explore their portfolio, understand their services, or book a call. They were invisible to the international market they wanted to reach.",
