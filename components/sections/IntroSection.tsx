...
const CLIENT_LOGOS = [
  ...
  { name: "Bedouin Trails",  src: "/clients/bedouintrails.png", scale: 1.35 },
  { name: "Window Adv",      src: "/clients/windowadv.png" },
  { name: "Captain Maged",   src: "/clients/captainmaged.webp" },
  { name: "Lamat El Arabia", src: "/clients/lamat-elarabia.png", scale: 1.3 },
];
      ...
      <div className="w-full max-w-[1440px] mx-auto flex flex-col gap-10">
        ...
        <div className="w-full grid grid-cols-2 md:grid-cols-5 gap-2">
          {CLIENT_LOGOS.map((logo, i) => (
            ...
            >
              <Image src={logo.src} alt={logo.name} width={160} height={64} className="object-contain w-auto h-full max-h-[80px] md:max-h-[72px]" style={logo.scale ? { transform: `scale(${logo.scale})` } : undefined} />
            </motion.div>
          ))}
        </div>
