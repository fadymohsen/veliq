...
const CLIENT_LOGOS = [
  ...
  { name: "Fanous Clinic",   src: "/clients/fanous-clinic.webp" },
  { name: "Yamin Estate",    src: "/clients/yamin-estate.webp" },
  { name: "RedBone Gym",     src: "/clients/redbone-gym.webp" },
  { name: "Saudi Hayat",     src: "/clients/saudi-hayat.webp" },
  { name: "Alfa Transport",  src: "/logos/alfa-transport.webp" },
  { name: "Coach Batool",    src: "/logos/coach-batool.webp" },
  { name: "Enjaz Care",      src: "/logos/enjazcare.webp" },
  { name: "Crewhub Studio",  src: "/logos/crewhub-studio.webp" },
  { name: "Brandlab",        src: "/clients/brandlab.webp", scale: 1.25 },
  { name: "Bedouin Trails",  src: "/clients/bedouintrails.webp" },
  { name: "Window Adv",      src: "/clients/windowadv.webp" },
  { name: "Captain Maged",   src: "/clients/captainmaged.webp" },
  { name: "Lamat El Arabia", src: "/clients/lamat-elarabia.webp", scale: 1.4 },
];
