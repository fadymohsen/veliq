        ...
        <div className="relative z-10 flex flex-col h-full pt-24 px-8 pb-10">
          ...
          >
            ...
            <div className="flex items-center justify-center gap-3">
              ...
              <a href="https://www.tiktok.com/@veliq.co" target="_blank" rel="noopener noreferrer" aria-label="TikTok" className="flex h-10 w-10 items-center justify-center rounded-xl border border-white/10 text-slate-500 transition-all duration-200 hover:bg-purple-500/10 hover:text-cyan-400 hover:border-purple-500/30">
