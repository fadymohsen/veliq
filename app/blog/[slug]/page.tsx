...
const CATEGORY_COVER: Record<string, { accent: string }> = {
  "Web Development":   { accent: "#818cf8" },
  "SEO":               { accent: "#c084fc" },
  "Mobile Development":{ accent: "#fb923c" },
  "Data & Analytics":  { accent: "#22d3ee" },
  "Brand Strategy":    { accent: "#fbbf24" },
