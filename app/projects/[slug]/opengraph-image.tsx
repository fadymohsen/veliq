    ...
    (
      ...
      >
        <div style={{ display: "flex", alignItems: "center", gap: "12px", marginBottom: "auto" }}>
          ...
          <div style={{ fontSize: "14px", color: "#a5b4fc", letterSpacing: "2px" }}>PROJECT</div>
        </div>
        <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
          <div style={{ fontSize: "56px", fontWeight: 700, color: "#fff", letterSpacing: "-2px", lineHeight: 1.1 }}>
            {title}
          </div>
          <div style={{ fontSize: "22px", color: "#a5b4fc", lineHeight: 1.4, maxWidth: "800px" }}>
            {desc}
          </div>
        </div>
      </div>
